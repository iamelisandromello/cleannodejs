...
const makeGeneratorStub = (): TokenGenerator => {
...
const makeUpdateAccessTokenRepository = (): UpdateAccessTokenRepository => {
  class UpdateAccessTokenRepositorytub implements UpdateAccessTokenRepository {
    async update (id: string, token: string): Promise<void> {
      return new Promise(resolve => resolve())
    }
  }
  return new UpdateAccessTokenRepositorytub()
}
...
const makeSut = (): SutTypes => {
  ...
  const tokenGeneratorStub = makeGeneratorStub()
